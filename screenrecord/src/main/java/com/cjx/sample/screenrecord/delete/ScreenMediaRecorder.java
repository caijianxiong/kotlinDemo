...
//
//        proj = mediaProjectionManager.createProjection(mUser, mContext.getPackageName(),
...
//        if (mAudioSource == ScreenRecordingAudioSource.INTERNAL ||
...
//                    mMediaProjection, mAudioSource == ScreenRecordingAudioSource.MIC_AND_INTERNAL);
//        }
//
//    }
//
...
//        if (mAudioSource == ScreenRecordingAudioSource.MIC_AND_INTERNAL || mAudioSource == ScreenRecordingAudioSource.INTERNAL) {
//            try {
